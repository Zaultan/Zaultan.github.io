...

{
  ...
  const fmt       = 'BO3';
  const teamA     = 'Iron Wing';
  const teamB     = 'Team Spirit';
  const scoreA    = 0;
  const scoreB    = 2;
  const game1     = '';
  const game2     = '';
...

{
  ...
  const roundName = 'Round 1';
  const fmt       = 'BO3';
  const teamA     = 'Team Vision';
  const teamB     = 'BoomBoys';
  const scoreA    = 2;
  const scoreB    = 1;
  const game1     = '';
  const game2     = '';
...

{
  ...
  const roundName = 'Round 1';
  const fmt       = 'BO3';
  const teamA     = 'Team Liquid';
  const teamB     = 'Team Yandex';
  const scoreA    = 0;
  const scoreB    = 2;
  const game1     = '';
  const game2     = '';
...

{
  ...
  const scoreA    = 2;
  const scoreB    = 1;
  const game1     = 'Team Liquid';
  const game2     = 'Team Falcons';
  const game3     = 'https://zault.net';
  const next      = 'LR2-2';
  const dropsTo   = null;
  matches.push({ id, path, roundName, fmt, teamA, teamB, scoreA, scoreB,
...

{
  ...
  const fmt       = 'BO3';
  const teamA     = 'Team Spirit';
  const teamB     = 'Team Vision';
  const scoreA    = 1;
  const scoreB    = 2;
  const game1     = '';
  const game2     = '';
